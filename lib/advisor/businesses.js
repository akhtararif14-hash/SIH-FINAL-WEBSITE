...
export const BUSINESSES = [
  {
    ...
    nameUr: 'کیفے / چائے کی دکان',
    nameBn: 'ক্যাফে / চায়ের দোকান',
    category: 'food',
  ...
  },
  {
    ...
    nameUr: 'ریستوران / فاسٹ فوڈ / ڈھابہ',
    nameBn: 'রেস্তোরাঁ / ফাস্ট ফুড / ধাবা',
    category: 'food',
  ...
  },
  {
    ...
    nameUr: 'بیکری / مٹھائی کی دکان',
    nameBn: 'বেকারি / মিষ্টির দোকান',
    category: 'food',
  ...
  },
  {
    ...
    nameUr: 'جوس / آئس کریم کی دکان',
    nameBn: 'জুস / আইসক্রিমের দোকান',
    category: 'food',
    competitors: [
  ...
  },
  {
    ...
    nameUr: 'کرانہ / راشن کی دکان',
    nameBn: 'মুদি / রেশনের দোকান',
    category: 'retail',
  ...
  },
  {
    ...
    nameUr: 'میڈیکل اسٹور / دوائی کی دکان',
    nameBn: 'মেডিকেল স্টোর / ওষুধের দোকান',
    category: 'health',
    competitors: [
      ['amenity', ['pharmacy']],
      ['shop', ['chemist']],
  ...
  },
  {
    ...
    nameUr: 'اسٹیشنری / فوٹو کاپی کی دکان',
    nameBn: 'স্টেশনারি / ফটোকপির দোকান',
    category: 'retail',
  ...
  },
  {
    ...
    nameUr: 'موبائل مرمت اور لوازمات',
    nameBn: 'মোবাইল মেরামত ও আনুষঙ্গিক',
    category: 'services',
    competitors: [
  ...
  },
  {
    ...
    nameUr: 'سیلون / بیوٹی پارلر',
    nameBn: 'সেলুন / বিউটি পার্লার',
    category: 'services',
  ...
  },
  {
    ...
    nameUr: 'لانڈری / ڈرائی کلیننگ',
    nameBn: 'লন্ড্রি / ড্রাই ক্লিনিং',
    category: 'services',
  ...
  },
  {
    ...
    nameUr: 'جم / فٹنس سینٹر',
    nameBn: 'জিম / ফিটনেস সেন্টার',
    category: 'services',
  ...
  },
  {
    ...
    nameUr: 'کوچنگ / ٹیوشن سینٹر',
    nameBn: 'কোচিং / টিউশন সেন্টার',
    category: 'education',
  ...
  },
  {
    ...
    nameUr: 'ہارڈویئر / پینٹ کی دکان',
    nameBn: 'হার্ডওয়্যার / রঙের দোকান',
    category: 'retail',
  ...
  },
  {
    ...
    nameUr: 'AC / کولر / آلات کی مرمت',
    nameBn: 'AC / কুলার / যন্ত্রপাতি মেরামত',
    category: 'services',
...
// The business name in the chosen language, falling back to English.
export function businessName(business, lang = 'en') {
  if (!business) return '';
  if (lang === 'hi') return business.nameHi || business.name;
  if (lang === 'ur') return business.nameUr || business.name;
  if (lang === 'bn') return business.nameBn || business.name;
