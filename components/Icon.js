...
const PATHS = {
  ...
  // --- welcome screen: the two choice cards ---
  // "login-01": an arrow going in through a door.
  login: (
    <>
  ...
  // "user-add-01": a person with a plus sign.
  userAdd: (
    <>
      <path d="M3 20.5002C3.28417 16.8058 6.3 13.7193 10.0008 13.5379C10.3134 13.5226 10.6446 13.5097 11 13.5L11.995 13.5663C12.6939 13.6129 13.3665 13.7543 14 13.9777" />
      <path d="M18 15.5V21.5M21 18.5L15 18.5" />
